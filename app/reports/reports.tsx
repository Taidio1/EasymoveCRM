  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground">Przeglądaj i pobieraj raporty w formatach PDF i Word</p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="border rounded-lg p-4">
              ...
              <ul className="space-y-2">
                ...
                <li className="flex justify-between">
                  <span>Podsumowanie klientów</span>
                  <button className="text-primary">Pobierz PDF</button>
                </li>
              </ul>
            </div>
            
            {/* Sekcja raportów tylko dla szefa */}
            <RoleGuard allowedRoles={["boss", "admin"]}>
              <div className="border rounded-lg p-4 bg-muted/30">
                <h3 className="text-lg font-medium mb-2">Raporty zaawansowane</h3>
                <p className="text-sm text-muted-foreground mb-2">Dostępne tylko dla szefa i administratorów</p>
                <ul className="space-y-2">
                  <li className="flex justify-between">
